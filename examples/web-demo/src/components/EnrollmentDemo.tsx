...
export function EnrollmentDemo({ onEvent }: EnrollmentDemoProps) {
  ...
  const client = createUseSenseClient({
    apiBaseUrl: process.env.NEXT_PUBLIC_API_BASE_URL || 'https://api.usesense.ai/functions/v1/make-server-fc4cf30d',
...
{`NEXT_PUBLIC_API_BASE_URL=https://api.usesense.ai/functions/v1/make-server-fc4cf30d
